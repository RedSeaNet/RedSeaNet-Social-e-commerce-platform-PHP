...
(function (window) {
    ...
    // grid items:
    var items = [].slice.call(document.querySelectorAll('ul.posts-list > .like'));
    function init() {
        /* Icon 1 */
        var el1 = items[0].querySelector('a.like'), el1span = el1.querySelector('i');
        new Animocon(el1, {
            tweens: [
                // burst animation
                new mojs.Burst({
        ...
        /* Icon 2 */
        var el2 = items[1].querySelector('a.like'), el2span = el2.querySelector('i');
        new Animocon(el2, {
            tweens: [
                // burst animation
                new mojs.Burst({
