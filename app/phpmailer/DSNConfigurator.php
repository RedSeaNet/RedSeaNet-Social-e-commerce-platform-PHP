...
class DSNConfigurator
{
    ...
    private function configureOptions(PHPMailer $mailer, $options)
    {
        ...
        unset($allowedOptions['Mailer'], $allowedOptions['SMTPAuth'], $allowedOptions['Username'], $allowedOptions['Password'], $allowedOptions['Hostname'], $allowedOptions['Port'], $allowedOptions['ErrorInfo']);
