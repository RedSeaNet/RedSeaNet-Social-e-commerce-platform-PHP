...
namespace Redseanet\Admin\Controller\Api\Soap;

use Redseanet\Api\Model\Soap\Role as Model;
...
class RoleController extends AuthActionController
{
    ...
    {
        return $this->doDelete('\\Redseanet\\Api\\Model\\Soap\\Role', ':ADMIN/api_soap_role/list/');
    }
