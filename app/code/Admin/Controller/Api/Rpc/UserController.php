...
use Redseanet\Api\Model\Rpc\User as Model;
...
class UserController extends AuthActionController
{
    ...
    {
        return $this->getLayout('admin_rpc_user_list');
    }

    public function editAction()
    {
        $root = $this->getLayout('admin_rpc_user_edit');
        if ($id = $this->getRequest()->getQuery('id')) {
            $model = new Model();
            $model->load($id);
            $root->getChild('edit', true)->setVariable('model', $model);
            $root->getChild('head')->setTitle('Edit RPC User / RPC');
        } else {
            ...
            $root->getChild('head')->setTitle('Add New RPC User / RPC');
        }
        return $root;
    }
    ...
    {
        return $this->doDelete('\\Redseanet\\Api\\Model\\Rpc\\User', ':ADMIN/api_rpc_user/');
    }
    ...
    public function saveAction()
    {
        ...
        return $this->response($result, ':ADMIN/api_rpc_user/');
    }
}
